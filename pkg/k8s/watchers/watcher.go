...
type svcManager interface {
	...
	RegisterL7LBService(name, namespace string, resourceName string, ingress bool, proxyPort uint16) error
	RemoveL7LBService(name, namespace string, resourceName string, ingress bool) error
}
